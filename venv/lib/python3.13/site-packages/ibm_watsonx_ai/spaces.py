...
class Spaces(WMLResource):
    ...
    async def adelete(self, space_id: str) -> Literal["SUCCESS"]:
        ...
        **Example:**
        ...
        response_delete = await self._client.async_httpx_client.delete(
            space_endpoint, headers=await self._client._aget_headers()
        )
    ...
    async def aget_details(
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            space_details = await client.spaces.aget_details(limit=100, get_all=True)
            space_details = []
            for entry in await client.spaces.aget_details(limit=100, asynchronous=True, get_all=True):
                space_details.extend(entry)
        ...
        if space_id is not None:
            response_get = await self._client.async_httpx_client.get(
                href, headers=await self._client._aget_headers(), params=query_params
            )
    ...
    async def aupdate(self, space_id: str, changes: dict) -> dict:
        ...
        **Example:**
        ...
        response = await self._client.async_httpx_client.patch(
            href, json=patch_payload, headers=await self._client._aget_headers()
        )
    ...
    async def acreate_member(self, space_id: str, meta_props: dict) -> dict:
        ...
        **Examples**
        ...
        .. code-block:: python
            ...
            members_details = await client.spaces.acreate_member(space_id=space_id, meta_props=metadata)
    ...
    async def aget_member_details(self, space_id: str, member_id: str) -> dict:
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            member_details = await client.spaces.aget_member_details(space_id,member_id)
        """
        Spaces._validate_type(space_id, "space_id", str, True)
        Spaces._validate_type(member_id, "member_id", str, True)
        ...
        response_get = await self._client.async_httpx_client.get(
            href, headers=await self._client._aget_headers()
        )
    ...
    async def adelete_member(self, space_id: str, member_id: str) -> str:
        ...
        **Example:**
        ...
        response_delete = await self._client.async_httpx_client.delete(
            member_endpoint, headers=await self._client._aget_headers()
        )
    ...
    async def aupdate_member(
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            member_details = await client.spaces.aupdate_member(space_id, member_id, changes=metadata)
        """
        self._validate_type(space_id, "space_id", str, True)
        self._validate_type(member_id, "member_id", str, True)
        self._validate_type(changes, "changes", dict, True)
    ...
    async def apromote(
        ...
        **Examples**
        ...
        .. code-block:: python
            ...
            promoted_asset_id = await client.spaces.apromote(asset_id, source_project_id=project_id, target_space_id=space_id)
            promoted_model_id = await client.spaces.apromote(model_id, source_project_id=project_id, target_space_id=space_id)
            promoted_function_id = await client.spaces.apromote(function_id, source_project_id=project_id, target_space_id=space_id)
            promoted_data_asset_id = await client.spaces.apromote(data_asset_id, source_project_id=project_id, target_space_id=space_id)
            promoted_connection_asset_id = await client.spaces.apromote(connection_id, source_project_id=project_id, target_space_id=space_id)
        """
        promote_payload = {
            "spaceId": target_space_id,
            "projectId": source_project_id,
