...
class Pipelines(WMLResource):
    ...
    async def astore(self, meta_props: dict, **kwargs) -> dict:
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            pipeline_details = await client.pipelines.astore(training_definition_filepath, meta_props=metadata)
    ...
    def create_revision(self, pipeline_id: str | None = None, **kwargs) -> dict:
    ...
    async def aupdate(
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            pipeline_details = await client.pipelines.aupdate(pipeline_id, changes=metadata)
    ...
    def delete(self, pipeline_id: str | None = None, **kwargs) -> Literal["SUCCESS"]:
    ...
    async def aget_details(
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            pipeline_details = await client.pipelines.aget_details(pipeline_name='Sample_pipeline')
            pipeline_details = await client.pipelines.aget_details()
            pipeline_details = await client.pipelines.aget_details(limit=100)
            pipeline_details = await client.pipelines.aget_details(limit=100, get_all=True)
            pipeline_details = []
            for entry in await client.pipelines.aget_details(limit=100, asynchronous=True, get_all=True):
                pipeline_details.extend(entry)
    ...
    async def aget_revision_details(self, pipeline_id: str, rev_id: str) -> dict:
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            pipeline_details = await client.pipelines.aget_revision_details(pipeline_id, rev_id)
    ...
    def list_revisions(
        self, pipeline_id: str | None = None, limit: int | None = None, **kwargs
    ) -> DataFrame:
