...
class Experiments(WMLResource):
    ...
    async def astore(self, meta_props: dict) -> dict:
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            experiment_details = await client.experiments.astore(meta_props=metadata)
            experiment_href = client.experiments.get_href(experiment_details)
    ...
    async def aupdate(self, experiment_id: str, changes: dict) -> dict:
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            exp_details = await client.experiments.aupdate(experiment_id, changes=metadata)
    ...
    async def aget_details(
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            experiment_details = await client.experiments.aget_details(experiment_id)
            experiment_details = await client.experiments.aget_details(experiment_name='Sample_experiment')
            ...
            experiment_details = await client.experiments.aget_details(limit=100, get_all=True)
            experiment_details = []
            for entry in await client.experiments.aget_details(limit=100, asynchronous=True, get_all=True):
                experiment_details.extend(entry)
    ...
    async def acreate_revision(self, experiment_id: str) -> dict:
        ...
        **Example:**
        ...
        .. code-block:: python
            ...
            experiment_revision_artifact = await client.experiments.acreate_revision(experiment_id)
    ...
    async def aget_revision_details(
        ...
        .. code-block:: python
            ...
            experiment_details = await client.experiments.aget_revision_details(experiment_id, rev_id)
